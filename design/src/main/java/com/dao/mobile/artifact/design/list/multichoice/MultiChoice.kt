...
class MultiChoice
{
    abstract class Adapter<T : Parcelable, V : ViewHolder>(
        context: Context,
        list: MutableList<T>,
        private val listener: OnMultiChoiceModeListener? = null) : Recycler.Adapter<T, V>(context, list)
    ...
    abstract class ViewHolder(view: View) : RecyclerView.ViewHolder(view)
    {
        ...
        private val onClick = View.OnClickListener { callback?.onClick(this) }
        private val onLongClick = View.OnLongClickListener { callback?.onLongClick(this)!! }
